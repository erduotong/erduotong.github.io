...
### 配置
1.  前往[Giscus的网站](https://giscus.app/zh-CN)，向下滑动找到 `配置`，并且选择一个合适的语言![IMG-20251018 215536028-2.5a1 添加Giscus评论.png](/image/IMG-20251018 215536028-2.5a1 添加Giscus评论.png)
2. 找到仓库，填入你刚刚的仓库
   例如，你的Github仓库地址是 `https://github.com/<your-id>/<name>`
   那么，就这样填写仓库这一栏: 
   `<your-id>/<name>`![IMG-20251018 215536645-2.5a1 添加Giscus评论.png](/image/IMG-20251018 215536645-2.5a1 添加Giscus评论.png)
   等待一段时间，若网站说明识别通过，那么就可以继续了。![IMG-20251018 215548584-2.5a1 添加Giscus评论.png](/image/IMG-20251018 215548584-2.5a1 添加Giscus评论.png)
