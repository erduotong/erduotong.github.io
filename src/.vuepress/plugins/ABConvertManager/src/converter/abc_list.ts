...
export class ListProcess {
    ...
    static data2nodes(listdata: List_ListItem, el: HTMLElement): HTMLElement {
        ...
        el_root2.classList.add("ab-nodes-children") // 特点是无对应的content和bracket
        ...
        for (let item of listdata) {
            ...
            el_node.setAttribute("has_children", "false"); // 为false则: chileren不应该显示、content线短一些
