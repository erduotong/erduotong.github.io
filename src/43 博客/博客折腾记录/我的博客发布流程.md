...
![550](/image/IMG-20250608 215814742-我的博客发布流程.png)

以及，Vuepress那边有个很难受的特性，公开资源一定要放在 `public` 文件夹中，不能直接方便的放在文件夹里面。~~并且我也不想建图床~~ 所以，还得再来一个处理，把图片啥的移动过去
![600](/image/IMG-20250608 215814781-我的博客发布流程.png)

顺手的事，还能处理一下`frontmatter`，把格式啥的转换一下。
![525](/image/IMG-20250608 215814822-我的博客发布流程.png)
...
![IMG-20250608 215814870-我的博客发布流程.png](/image/IMG-20250608 215814870-我的博客发布流程.png)
具体而言，就是下面这个过程:
...
![IMG-20250608 215814923-我的博客发布流程.png](/image/IMG-20250608 215814923-我的博客发布流程.png)
